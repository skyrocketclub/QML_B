...
#include <memory>
#include "../../../cpp_integration_2/cat.h"
...
QT_MOC_LITERAL(4, 4), // "meow"
QT_MOC_LITERAL(9, 0), // ""
QT_MOC_LITERAL(10, 11), // "nameChanged"
QT_MOC_LITERAL(22, 4), // "call"
QT_MOC_LITERAL(27, 4) // "name"

    },
    "Cat\0meow\0\0nameChanged\0call\0name"
};
...
void Cat::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Cat::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cat::meow)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Cat::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cat::nameChanged)) {
                *result = 1;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<QString, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
